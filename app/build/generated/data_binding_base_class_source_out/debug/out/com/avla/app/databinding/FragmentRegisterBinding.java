...
public final class FragmentRegisterBinding implements ViewBinding {
  ...
  private FragmentRegisterBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnRegister,
      ...
      @NonNull RadioButton rbLandlord, @NonNull RadioButton rbStudent, @NonNull RadioGroup rgRole,
  ...
  public static FragmentRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRegisterBinding((ScrollView) rootView, btnRegister, etEmail, etFullName,
          etPassword, etPhone, rbLandlord, rbStudent, rgRole, tilEmail, tilFullName, tilPassword,
          tilPhone, tvLogin);
    }
